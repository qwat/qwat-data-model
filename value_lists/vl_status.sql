...
INSERT INTO qwat_vl.status (id, active, code_sire, value_en, value_fr, value_ro, description_en, description_fr, description_ro) VALUES (1301, true, 1,     'in use',         'en service',   'Funcţional',   '', 'Contribue actuellement au réseau.', 'Contribuie efectiv la reţea.');    /*  */
