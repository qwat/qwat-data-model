...
INSERT INTO qwat_vl.status (id, active, functional, value_en, value_fr, value_ro, description_en, description_fr, description_ro) VALUES (1306, false, false, 'Project planned',        'Projet planifie',       'Proiect planificat',      '', 'L''objet est un projet validé en attente', 'Obiectul face parte dintr-un proiect planificat');    /*  */
INSERT INTO qwat_vl.status (id, active, functional, value_en, value_fr, value_ro, description_en, description_fr, description_ro) VALUES (1308, false, false, 'Project in execution',        'Projet en execution',       'Proiect în execuție',      'The object is part of a project that''s already in execution', 'L''objet est un projet validé en cours de réalisation', 'Obiectul face parte dintr-un proiect care este în curs de execuție');    /*  */
