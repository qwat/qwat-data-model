...
INSERT INTO qwat_vl.valve_function (id, value_fr, short_fr, value_ro )       	VALUES (6102,'ventouse','Ve','aerisire'); 			/* 2  VE   */
...
INSERT INTO qwat_vl.valve_function (id, value_fr, value_ro, schema_visible ) 	VALUES (6105,'vanne branchement','robinet concesie','false'); 	/* 5  VBR  */
...
INSERT INTO qwat_vl.valve_function (id, value_fr, value_ro)                  	VALUES (6111,'vanne réseau','vană cu sertar'); 			/* 11 VR   */
INSERT INTO qwat_vl.valve_function (id, value_fr, short_fr, value_ro)        	VALUES (6112,'vidange-ventouse','ViVe','golire-aerisire');      /* 12 VIVE */
