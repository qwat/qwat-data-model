...
CREATE OR REPLACE FUNCTION qwat_app.fn_valve_set_orientation(_valve_id integer) RETURNS void AS
$BODY$
    DECLARE
        _pipeitem     record;
        _pipe_id      integer;
...
$BODY$
LANGUAGE plpgsql;
COMMENT ON FUNCTION qwat_app.fn_node_set_type(integer) IS 'Set the orientation for a valve.';
