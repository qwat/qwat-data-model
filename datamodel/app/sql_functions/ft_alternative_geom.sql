...
CREATE OR REPLACE FUNCTION qwat_app.ft_geometry_alternative_main() RETURNS TRIGGER AS
	$BODY$
	BEGIN
...
CREATE OR REPLACE FUNCTION qwat_app.ft_geometry_alternative_aux() RETURNS TRIGGER AS
	$BODY$
	BEGIN
