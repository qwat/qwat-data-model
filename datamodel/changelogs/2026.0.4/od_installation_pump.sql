...
ALTER TABLE qwat_od.pump ADD COLUMN fk_pump_operating      smallint     ;
...
ALTER TABLE qwat_od.pump ADD CONSTRAINT pump_fk_pump_operating FOREIGN KEY (fk_pump_operating) REFERENCES qwat_vl.pump_operating(id) MATCH FULL; CREATE INDEX fki_pump_operating ON qwat_od.pump(fk_pump_operating) ;
