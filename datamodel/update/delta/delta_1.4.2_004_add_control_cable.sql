...
COMMENT ON COLUMN qwat_od.sia405cc_cable.sur_plus_cover IS 'Numerical mean value of an object / Numerisch mittlerer Wert eines Objektes / Valeur moyenne d''un objet';
...
COMMENT ON COLUMN qwat_od.sia405cc_cable.width IS 'Width of cable trench / Breite Kabeltrasse / Largeur du tracé du câble';
