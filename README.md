...
A full web data model documentation with diagrams and relations is available in the [diagram](https://github.com/qwat/qwat-data-model/tree/master/diagram) folder of the current repository.
