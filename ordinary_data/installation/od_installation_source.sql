...
ALTER TABLE qwat_od.source ADD COLUMN fk_source_quality        smallint     ;
...
ALTER TABLE qwat_od.source ADD CONSTRAINT source_fk_source_quality FOREIGN KEY (fk_source_quality)     REFERENCES qwat_vl.source_quality(id) MATCH FULL; CREATE INDEX fki_source_source_quality ON qwat_od.source(fk_source_quality)    ;
