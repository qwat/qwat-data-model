...
/* Constraints */
ALTER TABLE qwat_od.installation_treatment ADD CONSTRAINT installation_treatment_fk_installation FOREIGN KEY (fk_installation) REFERENCES qwat_od.installation_building(id) MATCH SIMPLE; CREATE INDEX fki_installation_treatment_fk_installation ON qwat_od.installation_treatment(fk_installation);
...
ALTER TABLE qwat_od.installation_treatment ADD CONSTRAINT installation_treatment_fk_remote       FOREIGN KEY (fk_remote)       REFERENCES qwat_vl.remote_type(id)           MATCH SIMPLE; CREATE INDEX fki_installation_treatment_fk_remote       ON qwat_od.installation_treatment(fk_remote)      ;
