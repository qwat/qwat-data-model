...
ALTER TABLE qwat_od.sia405cc_cable_point ADD COLUMN symbolori_geometry geometry('POINT', :SRID);
CREATE INDEX in_qwat_sia405cc_cable_point_symbolori_geometry ON qwat_od.sia405cc_cable_point USING gist (symbolori_geometry );
COMMENT ON COLUMN qwat_od.sia405cc_cable_point.symbolori_geometry IS 'Default: 90 degree / Default: 90 Grad / Default: 90 degre';
