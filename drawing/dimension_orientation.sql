...
/* columns */
ALTER TABLE qwat_dr.dimension_orientation ADD COLUMN observation varchar(120) default '';
ALTER TABLE qwat_dr.dimension_orientation ADD COLUMN remark      text default '';
