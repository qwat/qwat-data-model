...
ALTER TABLE qwat.vl_watertype ADD COLUMN value_ro  varchar(30) default '';
ALTER TABLE qwat.vl_watertype ADD COLUMN code_sire smallint;

/* VALUES */
INSERT INTO qwat.vl_watertype (id, value_en, value_fr, value_ro, code_sire) VALUES (1501, 'raw'      , 'brute'       , 'brută', 	0 );
INSERT INTO qwat.vl_watertype (id, value_en, value_fr, value_ro, code_sire) VALUES (1502, 'drinkable', 'potable'     , 'potabilă', 	1 );
INSERT INTO qwat.vl_watertype (id, value_en, value_fr, value_ro, code_sire) VALUES (1503, 'industrial', 'industrielle','industrială',	2 );
