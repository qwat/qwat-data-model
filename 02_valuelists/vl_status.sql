...
INSERT INTO qwat_vl.status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1305, '', 'détruit', 'Distrus', false, NULL, '', 'L''objet a été partiellement ou complètement détruit.', 'Obiectul este distrus complet sau partial');    /*  */
...
INSERT INTO qwat_vl.status (id, value_en, value_fr, value_ro, active, sire, helper_en, helper_fr, helper_ro) VALUES (1301, '', 'en service', 'Functional', true, 1, '', 'Contribue actuellement au réseau.', 'Contribuie efectiv la reţea.');    /*  */
